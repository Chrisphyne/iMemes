...
import imemes.domain.com.imemes_meme_creator.util.IabBroadcastReceiver;
import imemes.domain.com.imemes_meme_creator.util.IabHelper;
import imemes.domain.com.imemes_meme_creator.util.IabResult;
import imemes.domain.com.imemes_meme_creator.util.Inventory;
import imemes.domain.com.imemes_meme_creator.util.Purchase;

import java.util.ArrayList;
import java.util.List;

import static imemes.domain.com.imemes_meme_creator.Constants.SKU_IMEMES_MONTHLY;
//import static imemes.domain.com.imemes_meme_creator.Constants.SKU_DELAROY_SIXMONTH;
//import static imemes.domain.com.imemes_meme_creator.Constants.SKU_DELAROY_THREEMONTH;
//import static imemes.domain.com.imemes_meme_creator.Constants.SKU_DELAROY_YEARLY;
import static imemes.domain.com.imemes_meme_creator.Constants.base64EncodedPublicKey;
...
public class MainActivity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    boolean mSubscribedToImemes = false;
...
//    String mThirdChoiceSku = "";
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            Purchase imemesMonthly = inventory.getPurchase(SKU_IMEMES_MONTHLY);
...
//            }
            ...
            // renewing
            mSubscribedToImemes = (imemesMonthly != null && verifyDeveloperPayload(imemesMonthly))
...
//                    || (delaroyYearly != null && verifyDeveloperPayload(delaroyYearly))
            ;
            Log.d(TAG, "User " + (mSubscribedToImemes ? "HAS" : "DOES NOT HAVE")
                    + " infinite Memes Creator subscription.");
    ...
    public void onSubscribeButtonClicked(View arg0) {
        ...
        if (!mSubscribedToImemes || !mAutoRenewEnabled) {
...
//            options[3] = getString(R.string.subscription_period_yearly);
            mFirstChoiceSku = SKU_IMEMES_MONTHLY;
...
//            mFourthChoiceSku = SKU_DELAROY_YEARLY;
            ...
            options = new CharSequence[1];
            if (mImemesSku.equals(SKU_IMEMES_MONTHLY)) {
...
//                mThirdChoiceSku = SKU_DELAROY_YEARLY;
            } else if (mImemesSku.equals(SKU_IMEMES_MONTHLY)){
...
//        }
            ...
            if (!TextUtils.isEmpty(mImemesSku)
                    && !mImemesSku.equals(mSelectedSubscriptionPeriod)) {
                // The user currently has a valid subscription, any purchase action is going to
                // replace that subscription
                oldSkus = new ArrayList<String>();
                oldSkus.add(mImemesSku);
            }
...
//            mSecondChoiceSku = "";
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (purchase.getSku().equals(SKU_IMEMES_MONTHLY)
...
//                    || purchase.getSku().equals(SKU_DELAROY_YEARLY)
                ...
                Log.d(TAG, "Memes Creator subscription purchased.");
                alert("Thank you for subscribing to Memes Creator!");
                mSubscribedToImemes = true;
                mAutoRenewEnabled = purchase.isAutoRenewing();
                mImemesSku = purchase.getSku();
                updateUi();
                setWaitScreen(false);
            }
        }
    ...
    void complain(String message) {
        Log.e(TAG, "**** Memes Creator Error: " + message);
        alert("Error: " + message);
    }
